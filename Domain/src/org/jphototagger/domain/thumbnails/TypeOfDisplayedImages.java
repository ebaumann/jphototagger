...
/**
 * TypeOfDisplayedImages type of the displayed thumbnails.
 */
public enum TypeOfDisplayedImages {
     ...
     * file system
     */
    private static final Set<TypeOfDisplayedImages> CONTENT_DELETE_IMAGES_FROM_FILESYSTEM_ALLOWED = new HashSet<TypeOfDisplayedImages>();
    /**
     * Contents where images located elsewhere in the file system can be
     * inserted
     */
    private static final Set<TypeOfDisplayedImages> CONTENT_INSERT_IMAGES_FROM_FILESYSTEM_ALLOWED = new HashSet<TypeOfDisplayedImages>();
    ...
    static {
        ...
        for (TypeOfDisplayedImages content : values()) {
