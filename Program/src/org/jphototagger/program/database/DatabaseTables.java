...
public final class DatabaseTables extends Database {
    ...
    public void createTables() {
        ...
        try {
            ...
            createUserDefinedFileFilterTable(con, stmt);
    ...
    private void createUserDefinedFileFilterTable(Connection con,
            Statement stmt)
            throws SQLException {
        if (!DatabaseMetadata.INSTANCE.existsTable(con,
                "user_defined_file_filter")) {
            stmt.execute(
                "CREATE CACHED TABLE user_defined_file_filter"
                + " (id BIGINT GENERATED BY DEFAULT"
                + " AS IDENTITY(START WITH 1, INCREMENT BY 1) PRIMARY KEY"
            ...
            stmt.execute(
                "CREATE UNIQUE INDEX idx_user_defined_file_filter_name"
                + " ON user_defined_file_filter (name)");
        }
    }
}
