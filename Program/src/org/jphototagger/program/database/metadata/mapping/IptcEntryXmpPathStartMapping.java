...
public final class IptcEntryXmpPathStartMapping {
    private static final Map<IPTCEntryMeta, String> XMP_PATH_START_OF_IPTC_ENTRY_META = new HashMap<IPTCEntryMeta,
                                                                                            String>();
    ...
    static {
        ...
        XMP_PATH_START_OF_IPTC_ENTRY_META.put(IPTCEntryMeta.ORIGINAL_TRANSMISSION_REFERENCE,
