...
public final class ControllerGoTo implements ActionListener {
    private final Map<AppFrame.GoTo, Component> componentOfGoTo = new EnumMap<AppFrame.GoTo,
                                                                      Component>(AppFrame.GoTo.class);
    private final Map<AppFrame.GoTo, JTabbedPane> tabbedPaneOfGoTo = new EnumMap<AppFrame.GoTo,
                                                                         JTabbedPane>(AppFrame.GoTo.class);
