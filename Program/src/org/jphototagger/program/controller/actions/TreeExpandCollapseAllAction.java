...
public final class TreeExpandCollapseAllAction extends AbstractAction {
    ...
    public static final String SELECTED_TEXT = JptBundle.INSTANCE.getString("TreeExpandCollapseAllAction.ToggleButton.Selected.Text");
    public static final String NOT_SELECTED_TEXT = JptBundle.INSTANCE.getString("TreeExpandCollapseAllAction.ToggleButton.NotSelected.Text");
    ...
    public void actionPerformed(ActionEvent ignored) {
        ...
        toggleButton.setText(selected ? SELECTED_TEXT : NOT_SELECTED_TEXT);
    }
