...
import org.jphototagger.program.controller.filesystem.FilenameFormatDate;
import org.jphototagger.program.controller.filesystem.FilenameFormatEmptyString;
...
public final class RenameDialog extends Dialog implements ListDataListener {
    ...
    private static final String KEY_SEL_TEMPLATE =
    ...
    private void renameViaTemplate() {
        ...
        for (int i = 0; !stop && (i < size); i++) {
            ...
            File newFile = new File(((parent == null)
                                     ? ""
                                     : parent
                                       + File.separator) + filenameFormatArray
                                           .format());
    ...
    private File getNewFileViaInput() {
        ...
        return new File(directory + (directory.isEmpty()
                                     ? ""
                                     : File.separator) + textFieldNewName
                                         .getText().trim());
    }
    ...
    private boolean checkNamesNotEquals(File oldFile, File newFile) {
        boolean equals =
            newFile.getAbsolutePath().equals(oldFile.getAbsolutePath());
    ...
    private void setFileToFilenameFormats(File file) {
        setFilenameFormatToSelectedItem(comboBoxAtBegin, file,
                                        textFieldAtBegin.getText().trim());
        setFilenameFormatToSelectedItem(comboBoxInTheMiddle, file,
                                        textFieldInTheMiddle.getText().trim());
        setFilenameFormatToSelectedItem(comboBoxAtEnd, file,
                                        textFieldAtEnd.getText().trim());
    }
    ...
    private void setFilenameFormatArray(File file) {
        ...
        filenameFormatArray.addFormat(
            new FilenameFormatConstantString(textFieldDelim1.getText().trim()));
        filenameFormatArray.addFormat(
            (FilenameFormat) comboBoxInTheMiddle.getSelectedItem());
        filenameFormatArray.addFormat(
            new FilenameFormatConstantString(textFieldDelim2.getText().trim()));
        filenameFormatArray.addFormat(
    ...
    private synchronized void setThumbnail(File file) {
        ...
        if (FileType.isJpegFile(file.getName())) {
            thumbnail = ThumbnailUtil.getThumbnailFromJavaImageIo(file,
                    panelThumbnail.getWidth());
        }
    ...
    private void setEnabledConstantTextFields() {
        textFieldAtBegin.setEditable(comboBoxAtBegin.getSelectedItem()
                                     instanceof FilenameFormatConstantString);
        textFieldInTheMiddle.setEditable(
            comboBoxInTheMiddle.getSelectedItem()
            instanceof FilenameFormatConstantString);
        textFieldAtEnd.setEditable(comboBoxAtEnd.getSelectedItem()
                                   instanceof FilenameFormatConstantString);
    }
    ...
    private void setTemplate(RenameTemplate template) {
        ...
        ComboBoxUtil.selectString(comboBoxDateDelimiter.getModel(),
                                  template.getDateDelimiter());
    ...
    private void setValuesToTemplate(RenameTemplate template) {
        template.setStartNumber(
            (Integer) spinnerStartNumber.getModel().getValue());
        template.setStepWidth(
            (Integer) spinnerNumberStepWidth.getModel().getValue());
        template.setNumberCount(
            (Integer) spinnerNumberCount.getModel().getValue());
        template.setDateDelimiter(getDateDelimiter());
        template.setFormatClassAtBegin(
            comboBoxAtBegin.getSelectedItem().getClass());
        template.setDelimiter1(textFieldDelim1.getText());
        template.setFormatClassInTheMiddle(
            comboBoxInTheMiddle.getSelectedItem().getClass());
        template.setDelimiter2(textFieldDelim2.getText());
        template.setFormatClassAtEnd(
            comboBoxAtEnd.getSelectedItem().getClass());
    ...
    private void handleComboBoxRenameTemplatesActionPerformed() {
        if (listen) {
            UserSettings.INSTANCE.getSettings().setSelectedIndex(
                comboBoxRenameTemplates, KEY_SEL_TEMPLATE);
    ...
    private void initComponents() {
        ...
        panelThumbnail             =
            new org.jphototagger.lib.component.ImagePanel();
        ...
        panelInputName.addComponentListener(
            new java.awt.event.ComponentAdapter() {
            public void componentShown(java.awt.event.ComponentEvent evt) {
                panelInputNameComponentShown(evt);
            }
        });
        labelDirectoryPrompt.setText(
            JptBundle.INSTANCE.getString(
                "RenameDialog.labelDirectoryPrompt.text"));    // NOI18N
        labelDirectory.setForeground(new java.awt.Color(0, 175, 0));
        labelDirectory.setText(
            JptBundle.INSTANCE.getString("RenameDialog.labelDirectory.text"));    // NOI18N
        panelBorder.setBorder(
        ...
        javax.swing.GroupLayout panelThumbnailLayout =
            new javax.swing.GroupLayout(panelThumbnail);

        panelThumbnail.setLayout(panelThumbnailLayout);
        panelThumbnailLayout.setHorizontalGroup(
            panelThumbnailLayout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addGap(
                0, 180, Short.MAX_VALUE));
        panelThumbnailLayout.setVerticalGroup(
            panelThumbnailLayout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addGap(
                0, 170, Short.MAX_VALUE));

        javax.swing.GroupLayout panelBorderLayout =
            new javax.swing.GroupLayout(panelBorder);

        panelBorder.setLayout(panelBorderLayout);
        panelBorderLayout.setHorizontalGroup(
            panelBorderLayout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addComponent(
                panelThumbnail, javax.swing.GroupLayout.PREFERRED_SIZE, 180,
                javax.swing.GroupLayout.PREFERRED_SIZE));
        panelBorderLayout.setVerticalGroup(
            panelBorderLayout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addComponent(
                panelThumbnail, javax.swing.GroupLayout.PREFERRED_SIZE,
                javax.swing.GroupLayout.DEFAULT_SIZE,
                javax.swing.GroupLayout.PREFERRED_SIZE));
        labelOldNamePrompt.setText(
            JptBundle.INSTANCE.getString(
                "RenameDialog.labelOldNamePrompt.text"));    // NOI18N
        labelOldName.setForeground(new java.awt.Color(0, 175, 0));
        labelOldName.setText(
            JptBundle.INSTANCE.getString("RenameDialog.labelOldName.text"));    // NOI18N
        labelNewNamePrompt.setLabelFor(textFieldNewName);
        labelNewNamePrompt.setText(
            JptBundle.INSTANCE.getString(
                "RenameDialog.labelNewNamePrompt.text"));    // NOI18N
        buttonNextFile.setText(
            JptBundle.INSTANCE.getString("RenameDialog.buttonNextFile.text"));    // NOI18N
        ...
        buttonRename.setText(
            JptBundle.INSTANCE.getString("RenameDialog.buttonRename.text"));    // NOI18N
        ...
        javax.swing.GroupLayout panelInputNameLayout =
            new javax.swing.GroupLayout(panelInputName);

        panelInputName.setLayout(panelInputNameLayout);
        panelInputNameLayout.setHorizontalGroup(
            panelInputNameLayout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                panelInputNameLayout.createSequentialGroup().addGroup(
                    panelInputNameLayout.createParallelGroup(
                        javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                        panelInputNameLayout.createSequentialGroup().addGap(
                            ...
                            javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                                ...
                                panelInputNameLayout.createParallelGroup(
                                    ...
                                    javax.swing.GroupLayout.Alignment.LEADING).addComponent(
                                        ...
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        368, Short.MAX_VALUE).addComponent(
                                            labelOldNamePrompt,
                                                javax.swing.GroupLayout.Alignment.LEADING).addComponent(
                                                    textFieldNewName,
                                                        javax.swing.GroupLayout.Alignment.LEADING,
                                                            javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                ...
                                                                Short.MAX_VALUE))).addGroup(
                                                                    javax.swing.GroupLayout.Alignment.TRAILING,
                                                                        panelInputNameLayout.createSequentialGroup().addContainerGap(
                                                                            322,
                                                                            Short.MAX_VALUE).addComponent(
                                                                                buttonNextFile).addPreferredGap(
                                                                                    javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                                                                                        buttonRename)).addGroup(
                                                                                            panelInputNameLayout.createSequentialGroup().addContainerGap().addGroup(
                                                                                                panelInputNameLayout.createParallelGroup(
                                                                                                    javax.swing.GroupLayout.Alignment.LEADING).addComponent(
                                                                                                        labelDirectory,
                                                                                                            javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                                568,
                                                                                                                Short.MAX_VALUE).addComponent(
                                                                                                                    labelDirectoryPrompt)))).addContainerGap()));
        panelInputNameLayout.setVerticalGroup(
            panelInputNameLayout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                panelInputNameLayout.createSequentialGroup().addContainerGap().addComponent(
                    labelDirectoryPrompt).addPreferredGap(
                    javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                    labelDirectory).addPreferredGap(
                    javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(
                    panelInputNameLayout.createParallelGroup(
                        javax.swing.GroupLayout.Alignment.LEADING).addComponent(
                        panelBorder, javax.swing.GroupLayout.PREFERRED_SIZE,
                        javax.swing.GroupLayout.DEFAULT_SIZE,
                        javax.swing.GroupLayout.PREFERRED_SIZE).addGroup(
                            panelInputNameLayout.createSequentialGroup().addComponent(
                                labelOldNamePrompt).addPreferredGap(
                                javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                                labelOldName).addPreferredGap(
                                javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                                labelNewNamePrompt).addPreferredGap(
                                javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                                textFieldNewName,
                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                                    ...
                                    280, Short.MAX_VALUE).addGroup(
                                        panelInputNameLayout.createParallelGroup(
                                            javax.swing.GroupLayout.Alignment.BASELINE).addComponent(
                                                buttonRename).addComponent(
                                                    buttonNextFile)))).addContainerGap()));
        tabbedPane.addTab(
            JptBundle.INSTANCE.getString(
                "RenameDialog.panelInputName.TabConstraints.tabTitle"), panelInputName);    // NOI18N
        panelNumbers.setBorder(
            javax.swing.BorderFactory.createTitledBorder(
                JptBundle.INSTANCE.getString(
                    "RenameDialog.panelNumbers.border.title")));    // NOI18N
        labelStartNumber.setLabelFor(spinnerStartNumber);
        labelStartNumber.setText(
            JptBundle.INSTANCE.getString("RenameDialog.labelStartNumber.text"));    // NOI18N
        spinnerStartNumber.setModel(new SpinnerNumberModel(1, 1, 999999, 1));
        spinnerStartNumber.addChangeListener(
        ...
        labelNumberStepWidth.setText(
            JptBundle.INSTANCE.getString(
                "RenameDialog.labelNumberStepWidth.text"));    // NOI18N
        spinnerNumberStepWidth.setModel(new SpinnerNumberModel(1, 1, 99, 1));
        spinnerNumberStepWidth.addChangeListener(
            new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
        ...
        labelNumberCount.setText(
            JptBundle.INSTANCE.getString("RenameDialog.labelNumberCount.text"));    // NOI18N
        spinnerNumberCount.setModel(new SpinnerNumberModel(3, 1, 7, 1));
        spinnerNumberCount.addChangeListener(
            new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
        ...
        javax.swing.GroupLayout panelNumbersLayout =
            new javax.swing.GroupLayout(panelNumbers);

        panelNumbers.setLayout(panelNumbersLayout);
        panelNumbersLayout.setHorizontalGroup(
            panelNumbersLayout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                panelNumbersLayout.createSequentialGroup().addContainerGap().addComponent(
                    labelStartNumber).addPreferredGap(
                    javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                    spinnerStartNumber, javax.swing.GroupLayout.PREFERRED_SIZE,
                    51, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                        javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                        labelNumberStepWidth).addPreferredGap(
                        javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                        spinnerNumberStepWidth,
                        javax.swing.GroupLayout.DEFAULT_SIZE, 51,
                        Short.MAX_VALUE).addGap(18, 18, 18).addComponent(
                            labelNumberCount).addPreferredGap(
                            javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                            spinnerNumberCount,
                            javax.swing.GroupLayout.PREFERRED_SIZE, 38,
                            javax.swing.GroupLayout.PREFERRED_SIZE).addContainerGap()));
        panelNumbersLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
        ...
        panelNumbersLayout.setVerticalGroup(
            panelNumbersLayout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                panelNumbersLayout.createSequentialGroup().addGroup(
                    panelNumbersLayout.createParallelGroup(
                        ...
                        javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(
                            labelNumberCount).addComponent(
                            spinnerNumberStepWidth,
                            javax.swing.GroupLayout.PREFERRED_SIZE,
                            javax.swing.GroupLayout.DEFAULT_SIZE,
                            javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(
                                labelNumberStepWidth).addComponent(
                                spinnerStartNumber,
                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(
                                    labelStartNumber)).addContainerGap(
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        Short.MAX_VALUE)));
        labelDateDelim.setText(
            JptBundle.INSTANCE.getString("RenameDialog.labelDateDelim.text"));    // NOI18N
        comboBoxDateDelimiter.setModel(new DefaultComboBoxModel(new Object[] {
            "",
            "-", ".", "/" }));
        comboBoxDateDelimiter.addActionListener(
        ...
        javax.swing.GroupLayout panelOtherLayout =
            new javax.swing.GroupLayout(panelOther);

        panelOther.setLayout(panelOtherLayout);
        panelOtherLayout
            .setHorizontalGroup(panelOtherLayout
                .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(panelOtherLayout.createSequentialGroup()
                    .addContainerGap().addComponent(labelDateDelim)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement
                        .RELATED)
                            .addComponent(comboBoxDateDelimiter, javax.swing
                                .GroupLayout.PREFERRED_SIZE, javax.swing
                                .GroupLayout.DEFAULT_SIZE, javax.swing
                                .GroupLayout.PREFERRED_SIZE)
                                    .addContainerGap(250, Short.MAX_VALUE)));
        panelOtherLayout
            .setVerticalGroup(panelOtherLayout
                .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(panelOtherLayout.createSequentialGroup()
                    .addGroup(panelOtherLayout
                        .createParallelGroup(javax.swing.GroupLayout.Alignment
                            .BASELINE).addComponent(labelDateDelim)
                                .addComponent(comboBoxDateDelimiter,
                                    javax.swing.GroupLayout.PREFERRED_SIZE,
                                    javax.swing.GroupLayout.DEFAULT_SIZE,
                                    javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addContainerGap(javax.swing.GroupLayout
                                            .DEFAULT_SIZE, Short.MAX_VALUE)));
        panelDefineName.setBorder(
            javax.swing.BorderFactory.createTitledBorder(
                JptBundle.INSTANCE.getString(
                    "RenameDialog.panelDefineName.border.title")));    // NOI18N
        labelAtBegin.setLabelFor(comboBoxAtBegin);
        labelAtBegin.setText(
            JptBundle.INSTANCE.getString("RenameDialog.labelAtBegin.text"));    // NOI18N
        ...
        labelDelim1.setText(
            JptBundle.INSTANCE.getString("RenameDialog.labelDelim1.text"));    // NOI18N
        ...
        labelInTheMid.setText(
            JptBundle.INSTANCE.getString("RenameDialog.labelInTheMid.text"));    // NOI18N
        comboBoxInTheMiddle.addActionListener(
            new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        labelDelim2.setText(
            JptBundle.INSTANCE.getString("RenameDialog.labelDelim2.text"));    // NOI18N
        ...
        labelAtEnd.setText(
            JptBundle.INSTANCE.getString("RenameDialog.labelAtEnd.text"));    // NOI18N
        ...
        javax.swing.GroupLayout panelDefineNameLayout =
            new javax.swing.GroupLayout(panelDefineName);

        panelDefineName.setLayout(panelDefineNameLayout);
        panelDefineNameLayout.setHorizontalGroup(
            panelDefineNameLayout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                panelDefineNameLayout.createSequentialGroup().addContainerGap().addGroup(
                    panelDefineNameLayout.createParallelGroup(
                        javax.swing.GroupLayout.Alignment.LEADING).addComponent(
                        textFieldAtBegin, javax.swing.GroupLayout.DEFAULT_SIZE,
                        116, Short.MAX_VALUE).addComponent(
                            comboBoxAtBegin, 0, 116,
                            Short.MAX_VALUE).addComponent(
                                labelAtBegin)).addPreferredGap(
                                    javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(
                                    panelDefineNameLayout.createParallelGroup(
                                        javax.swing.GroupLayout.Alignment.LEADING).addComponent(
                                        textFieldDelim1,
                                        ...
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(
                                            labelDelim1)).addPreferredGap(
                                                javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(
                                                    panelDefineNameLayout.createParallelGroup(
                                                        javax.swing.GroupLayout.Alignment.LEADING).addComponent(
                                                            textFieldInTheMiddle,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                    118,
                                                                    Short.MAX_VALUE).addComponent(
                                                                        comboBoxInTheMiddle,
                                                                                                ...
                                                                                                javax.swing.GroupLayout.Alignment.LEADING).addComponent(
                                                                                                    textFieldDelim2,
                                                                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                            javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(
                                                                                                                    labelDelim2)).addPreferredGap(
                                                                                                                        javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(
                                                                                                                            panelDefineNameLayout.createParallelGroup(
                                                                                                                                javax.swing.GroupLayout.Alignment.LEADING).addComponent(
                                                                                                                                    labelAtEnd).addComponent(
                                                                                                                                        comboBoxAtEnd,
                                                                                                                                            0, 132,
                                                                                                                                                Short.MAX_VALUE).addComponent(
                                                                                                                                                    textFieldAtEnd,
        ...
        panelDefineNameLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
                                       new java.awt.Component[] { labelDelim1,
                textFieldDelim1 });
        panelDefineNameLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
                                       new java.awt.Component[] { labelDelim2,
                textFieldDelim2 });
        panelDefineNameLayout.setVerticalGroup(
            panelDefineNameLayout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                panelDefineNameLayout.createSequentialGroup().addGroup(
                    panelDefineNameLayout.createParallelGroup(
                        javax.swing.GroupLayout.Alignment.CENTER).addComponent(
                        labelInTheMid).addComponent(labelDelim2).addComponent(
                        labelAtEnd).addComponent(labelAtBegin).addComponent(
                        labelDelim1)).addPreferredGap(
                            javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(
                            panelDefineNameLayout.createParallelGroup(
                                javax.swing.GroupLayout.Alignment.CENTER).addComponent(
                                                                                                                                    ...
                                                                                                                                    javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                                                            javax.swing.GroupLayout.PREFERRED_SIZE)).addContainerGap(
                                                                                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                                                                                    Short.MAX_VALUE)));
        panelDefineNameLayout.linkSize(javax.swing.SwingConstants.VERTICAL,
                                       new java.awt.Component[] {
                                           textFieldAtBegin,
                                           textFieldAtEnd,
                                           textFieldInTheMiddle });
        panelExample.setBorder(
            javax.swing.BorderFactory.createTitledBorder(
                JptBundle.INSTANCE.getString(
                    "RenameDialog.panelExample.border.title")));    // NOI18N
        labelBefore.setText(
            JptBundle.INSTANCE.getString("RenameDialog.labelBefore.text"));    // NOI18N
        labelBeforeFilename.setForeground(new java.awt.Color(0, 0, 175));
        labelBeforeFilename.setBorder(
            javax.swing.BorderFactory.createEtchedBorder());
        labelAfter.setText(
            JptBundle.INSTANCE.getString("RenameDialog.labelAfter.text"));    // NOI18N
        labelAfterFilename.setForeground(new java.awt.Color(0, 0, 255));
        labelAfterFilename.setBorder(
            javax.swing.BorderFactory.createEtchedBorder());

        javax.swing.GroupLayout panelExampleLayout =
            new javax.swing.GroupLayout(panelExample);

        panelExample.setLayout(panelExampleLayout);
        panelExampleLayout.setHorizontalGroup(
            panelExampleLayout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                javax.swing.GroupLayout.Alignment.TRAILING,
                panelExampleLayout.createSequentialGroup().addContainerGap().addGroup(
                    panelExampleLayout.createParallelGroup(
                        javax.swing.GroupLayout.Alignment.LEADING).addComponent(
                        labelAfter,
                        javax.swing.GroupLayout.Alignment.TRAILING).addComponent(
        ...
        panelExampleLayout.setVerticalGroup(
            panelExampleLayout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                panelExampleLayout.createSequentialGroup().addGroup(
                    panelExampleLayout.createParallelGroup(
                        javax.swing.GroupLayout.Alignment.CENTER).addComponent(
                        labelBeforeFilename,
                        javax.swing.GroupLayout.PREFERRED_SIZE, 22,
                        javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(
                            labelBefore)).addPreferredGap(
                                javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(
                                panelExampleLayout.createParallelGroup(
                                    javax.swing.GroupLayout.Alignment.CENTER).addComponent(
                                    labelAfterFilename,
                                    ...
                                    javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(
                                        labelAfter)).addContainerGap(
                                            javax.swing.GroupLayout.DEFAULT_SIZE,
                                                Short.MAX_VALUE)));
        panelExampleLayout.linkSize(javax.swing.SwingConstants.VERTICAL,
                                    new java.awt.Component[] {
                                        labelAfterFilename,
                                        labelBeforeFilename });
        panelRenameTemplates.setBorder(
            javax.swing.BorderFactory.createTitledBorder(
                JptBundle.INSTANCE.getString(
                    "RenameDialog.panelRenameTemplates.border.title")));    // NOI18N
        comboBoxRenameTemplates.setModel(new ComboBoxModelRenameTemplates());
        comboBoxRenameTemplates.addActionListener(
            new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comboBoxRenameTemplatesActionPerformed(evt);
            }
        });
        buttonSaveRenameTemplate.setText(
            JptBundle.INSTANCE.getString(
                "RenameDialog.buttonSaveRenameTemplate.text"));    // NOI18N
        buttonSaveRenameTemplate.setToolTipText(
            JptBundle.INSTANCE.getString(
                "RenameDialog.buttonSaveRenameTemplate.toolTipText"));    // NOI18N
        buttonSaveRenameTemplate.addActionListener(
            new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonSaveRenameTemplateActionPerformed(evt);
            }
        });
        buttonRenameRenameTemplate.setText(
            JptBundle.INSTANCE.getString(
                "RenameDialog.buttonRenameRenameTemplate.text"));    // NOI18N
        buttonRenameRenameTemplate.setToolTipText(
            JptBundle.INSTANCE.getString(
                "RenameDialog.buttonRenameRenameTemplate.toolTipText"));    // NOI18N
        buttonRenameRenameTemplate.setEnabled(false);
        buttonRenameRenameTemplate.addActionListener(
            new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonRenameRenameTemplateActionPerformed(evt);
            }
        });
        buttonDeleteRenameTemplate.setText(
            JptBundle.INSTANCE.getString(
                "RenameDialog.buttonDeleteRenameTemplate.text"));    // NOI18N
        buttonDeleteRenameTemplate.setToolTipText(
            JptBundle.INSTANCE.getString(
                "RenameDialog.buttonDeleteRenameTemplate.toolTipText"));    // NOI18N
        buttonDeleteRenameTemplate.setEnabled(false);
        buttonDeleteRenameTemplate.addActionListener(
            new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonDeleteRenameTemplateActionPerformed(evt);
            }
        });
        buttonUpdateRenameTemplate.setText(
            JptBundle.INSTANCE.getString(
                "RenameDialog.buttonUpdateRenameTemplate.text"));    // NOI18N
        buttonUpdateRenameTemplate.setToolTipText(
            JptBundle.INSTANCE.getString(
                "RenameDialog.buttonUpdateRenameTemplate.toolTipText"));    // NOI18N
        buttonUpdateRenameTemplate.setEnabled(false);
        buttonUpdateRenameTemplate.addActionListener(
            new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        javax.swing.GroupLayout panelRenameTemplatesLayout =
            new javax.swing.GroupLayout(panelRenameTemplates);

        panelRenameTemplates.setLayout(panelRenameTemplatesLayout);
        panelRenameTemplatesLayout.setHorizontalGroup(
            panelRenameTemplatesLayout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                panelRenameTemplatesLayout.createSequentialGroup().addContainerGap().addGroup(
                    panelRenameTemplatesLayout.createParallelGroup(
                        javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                        panelRenameTemplatesLayout.createSequentialGroup().addComponent(
                            comboBoxRenameTemplates, 0, 534,
                            Short.MAX_VALUE).addContainerGap()).addGroup(
                                panelRenameTemplatesLayout.createSequentialGroup().addComponent(
                                    buttonSaveRenameTemplate).addGap(
                                    6, 6, 6).addComponent(
                                    buttonUpdateRenameTemplate).addPreferredGap(
                                    javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                                    buttonRenameRenameTemplate).addPreferredGap(
                                    javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                                    buttonDeleteRenameTemplate).addGap(
                                    62, 62, 62)))));
        panelRenameTemplatesLayout.setVerticalGroup(
            panelRenameTemplatesLayout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                panelRenameTemplatesLayout.createSequentialGroup().addComponent(
                    comboBoxRenameTemplates,
                    javax.swing.GroupLayout.PREFERRED_SIZE,
                    javax.swing.GroupLayout.DEFAULT_SIZE,
                    javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                        javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(
                        panelRenameTemplatesLayout.createParallelGroup(
                            javax.swing.GroupLayout.Alignment.BASELINE).addComponent(
                            buttonSaveRenameTemplate).addComponent(
                            buttonRenameRenameTemplate).addComponent(
                            buttonDeleteRenameTemplate).addComponent(
                            buttonUpdateRenameTemplate)).addContainerGap(
                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                Short.MAX_VALUE)));
        buttonRenameTemplate.setText(
            JptBundle.INSTANCE.getString(
                "RenameDialog.buttonRenameTemplate.text"));    // NOI18N
        buttonRenameTemplate.addActionListener(
            new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        javax.swing.GroupLayout panelTemplatesLayout =
            new javax.swing.GroupLayout(panelTemplates);

        panelTemplates.setLayout(panelTemplatesLayout);
        panelTemplatesLayout.setHorizontalGroup(
            panelTemplatesLayout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                panelTemplatesLayout.createSequentialGroup().addContainerGap().addGroup(
                    panelTemplatesLayout.createParallelGroup(
                        javax.swing.GroupLayout.Alignment.LEADING).addComponent(
                        panelRenameTemplates,
                        javax.swing.GroupLayout.DEFAULT_SIZE,
                        javax.swing.GroupLayout.DEFAULT_SIZE,
                        Short.MAX_VALUE).addComponent(
                            panelDefineName,
                            ...
                            Short.MAX_VALUE).addComponent(
                                ...
                                Short.MAX_VALUE).addComponent(
                                    ...
                                    Short.MAX_VALUE).addComponent(
                                        ...
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        Short.MAX_VALUE).addComponent(
                                            buttonRenameTemplate,
                                                javax.swing.GroupLayout.Alignment.TRAILING)).addContainerGap()));
        panelTemplatesLayout.setVerticalGroup(
            panelTemplatesLayout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                panelTemplatesLayout.createSequentialGroup().addContainerGap().addComponent(
                    panelNumbers, javax.swing.GroupLayout.PREFERRED_SIZE,
                    javax.swing.GroupLayout.DEFAULT_SIZE,
                    javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                        javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                        panelOther, javax.swing.GroupLayout.PREFERRED_SIZE,
                        javax.swing.GroupLayout.DEFAULT_SIZE,
                        javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                            javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                            panelDefineName,
                            ...
                            javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                                ...
                                javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                                    ...
                                    javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                                        javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                                        buttonRenameTemplate).addContainerGap()));
        tabbedPane.addTab(
            JptBundle.INSTANCE.getString(
                "RenameDialog.panelTemplates.TabConstraints.tabTitle"), panelTemplates);    // NOI18N
        ...
        layout.setHorizontalGroup(
            layout.createParallelGroup(
                ...
                layout.createSequentialGroup().addContainerGap().addComponent(
                    tabbedPane, javax.swing.GroupLayout.DEFAULT_SIZE, 597,
                    Short.MAX_VALUE).addContainerGap()));
        layout.setVerticalGroup(
            layout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                layout.createSequentialGroup().addContainerGap().addComponent(
                    tabbedPane, javax.swing.GroupLayout.DEFAULT_SIZE, 480,
                    Short.MAX_VALUE).addContainerGap()));
        pack();
    ...
    private org.jphototagger.lib.component.ImagePanel panelThumbnail;
