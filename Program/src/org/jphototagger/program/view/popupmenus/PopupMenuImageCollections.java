...
public final class PopupMenuImageCollections extends JPopupMenu {
    ...
    private final JMenuItem itemDelete = new JMenuItem(Bundle.getString(PopupMenuImageCollections.class, "PopupMenuImageCollections.DisplayName.Action.Delete"), AppLookAndFeel.ICON_DELETE);
    private final JMenuItem itemRename = new JMenuItem(Bundle.getString(PopupMenuImageCollections.class, "PopupMenuImageCollections.DisplayName.Action.Rename"), AppLookAndFeel.ICON_RENAME);
    private final JMenuItem itemCreate = new JMenuItem(Bundle.getString(PopupMenuImageCollections.class, "PopupMenuImageCollections.DisplayName.Action.Create"), AppLookAndFeel.getIcon("icon_imagecollection.png"));
