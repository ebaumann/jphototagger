...
import org.jphototagger.program.module.actions.SearchInJxListAction;
import org.jphototagger.program.module.actions.SearchInJxTreeAction;
import org.jphototagger.program.module.actions.TreeExpandCollapseAllAction;
...
import org.jphototagger.program.view.panels.EditMetadataActionsPanel;
...
public final class AppPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        treeSelKeywords.setTransferHandler(new org.jphototagger.program.datatransfer.KeywordsTreeTransferHandler());
        ...
        treeMiscMetadata.setTransferHandler(new org.jphototagger.program.datatransfer.MiscMetadataTreeTransferHandler());
        ...
        comboBoxFastSearch.setModel(new org.jphototagger.program.model.FastSearchComboBoxModel());
        comboBoxFastSearch.setName("comboBoxFastSearch"); // NOI18N
        comboBoxFastSearch.setRenderer(new org.jphototagger.program.view.renderer.FastSearchMetaDataValuesListCellRenderer());
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("org/jphototagger/program/app/Bundle"); // NOI18N
        ...
        comboBoxFileFilters.setRenderer(new org.jphototagger.program.view.renderer.FileFiltersListCellRenderer());
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        treeDirectories.setModel(org.jphototagger.program.model.WaitTreeModel.INSTANCE);
        ...
        listSavedSearches.setModel(org.jphototagger.program.model.WaitListModel.INSTANCE);
        listSavedSearches.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        listSavedSearches.setCellRenderer(new org.jphototagger.program.view.renderer.SavedSearchesListCellRenderer());
        ...
        listImageCollections.setModel(org.jphototagger.program.model.WaitListModel.INSTANCE);
        listImageCollections.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        listImageCollections.setCellRenderer(new org.jphototagger.program.view.renderer.ImageCollectionsListCellRenderer());
        ...
        treeFavorites.setModel(org.jphototagger.program.model.WaitTreeModel.INSTANCE);
        ...
        treeSelKeywords.setModel(org.jphototagger.program.model.WaitTreeModel.INSTANCE);
        ...
        listSelKeywords.setModel(org.jphototagger.program.model.WaitListModel.INSTANCE);
        listSelKeywords.setCellRenderer(new org.jphototagger.program.view.renderer.KeywordsListCellRenderer());
        ...
        treeTimeline.setModel(org.jphototagger.program.model.WaitTreeModel.INSTANCE);
        treeTimeline.setCellRenderer(new org.jphototagger.program.view.renderer.TimelineTreeCellRenderer());
        ...
        treeMiscMetadata.setModel(org.jphototagger.program.model.WaitTreeModel.INSTANCE);
        treeMiscMetadata.setCellRenderer(new org.jphototagger.program.view.renderer.MiscMetadataTreeCellRenderer());
        ...
        listNoMetadata.setModel(org.jphototagger.program.model.WaitListModel.INSTANCE);
        ...
        tabbedPaneSelection.addTab(bundle.getString("AppPanel.panelNoMetadata.TabConstraints.tabTitle"), new javax.swing.ImageIcon(getClass().getResource("/org/jphototagger/program/resource/icons/icon_no_metadata.png")), panelNoMetadata); // NOI18N
        ...
        buttonExifToXmp.setToolTipText(bundle.getString("AppPanel.buttonExifToXmp.toolTipText")); // NOI18N
        ...
        tabbedPaneMetadata.addTab(bundle.getString("AppPanel.panelExif.TabConstraints.tabTitle"), new javax.swing.ImageIcon(getClass().getResource("/org/jphototagger/program/resource/icons/icon_exif.png")), panelExif); // NOI18N
        ...
        tabbedPaneMetadata.addTab(bundle.getString("AppPanel.panelIptc.TabConstraints.tabTitle"), new javax.swing.ImageIcon(getClass().getResource("/org/jphototagger/program/resource/icons/icon_iptc.png")), panelIptc); // NOI18N
        ...
        tabbedPaneXmp.addTab(bundle.getString("AppPanel.panelTableXmpTiff.TabConstraints.tabTitle"), panelTableXmpTiff); // NOI18N
        ...
        tabbedPaneXmp.addTab(bundle.getString("AppPanel.panelTableXmpExif.TabConstraints.tabTitle"), panelTableXmpExif); // NOI18N
        ...
        tabbedPaneXmp.addTab(bundle.getString("AppPanel.panelTableXmpDc.TabConstraints.tabTitle"), panelTableXmpDc); // NOI18N
        ...
        tabbedPaneXmp.addTab(bundle.getString("AppPanel.panelTableXmpIptc.TabConstraints.tabTitle"), panelTableXmpIptc); // NOI18N
        ...
        tabbedPaneXmp.addTab(bundle.getString("AppPanel.panelTableXmpPhotoshop.TabConstraints.tabTitle"), panelTableXmpPhotoshop); // NOI18N
        ...
        tabbedPaneXmp.addTab(bundle.getString("AppPanel.panelTableXmpXap.TabConstraints.tabTitle"), panelTableXmpXap); // NOI18N
        ...
        tabbedPaneXmp.addTab(bundle.getString("AppPanel.panelTableXmpLightroom.TabConstraints.tabTitle"), panelTableXmpLightroom); // NOI18N
        ...
        tabbedPaneXmp.addTab(bundle.getString("AppPanel.panelTableXmpCameraRawSettings.TabConstraints.tabTitle"), panelTableXmpCameraRawSettings); // NOI18N

        tabbedPaneMetadata.addTab(bundle.getString("AppPanel.tabbedPaneXmp.TabConstraints.tabTitle"), new javax.swing.ImageIcon(getClass().getResource("/org/jphototagger/program/resource/icons/icon_xmp.png")), tabbedPaneXmp); // NOI18N
