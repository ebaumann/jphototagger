...
public class AppLoggingSystemSettingsPanel extends PanelExt implements OptionPageProvider {
    ...
    private void buttonAddErrorTextActionPerformed(java.awt.event.ActionEvent evt) {
        addErrorText();
    }

    private void buttonRemoveErrorTextActionPerformed(java.awt.event.ActionEvent evt) {
        removeErrorText();
    }

    private void buttonEditErrorTextActionPerformed(java.awt.event.ActionEvent evt) {
        editErrorText();
    }

    private void comboBoxLogLevelActionPerformed(java.awt.event.ActionEvent evt) {
        persistLogLevel();
    }
