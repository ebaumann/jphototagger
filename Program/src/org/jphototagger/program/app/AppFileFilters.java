...
public final class AppFileFilters {
     ...
     */
    public static final RegexFileFilter ACCEPTED_IMAGE_FILENAMES = new RegexFileFilter(".*\\.[cC][rR][wW];"    // Canon RAW
        + ".*\\.[cC][rR]2;"    // Canon RAW 2
        + ".*\\.[dD][cC][rR];"    // Kodak RAW
        ...
        + (experimental
           ...
           + ".*\\.[tT][iI][fF][fF];"    // Tagged Image File Format
               , ";");
    public static final RegexFileFilter RAW_FILENAMES = new RegexFileFilter(".*\\.[cC][rR][wW];"    // Canon RAW
        + ".*\\.[cC][rR]2;"    // Canon RAW 2
        + ".*\\.[dD][cC][rR];"    // Kodak RAW
        + ".*\\.[mM][rR][wW];"    // Minolta RAW
        + ".*\\.[nN][eE][fF];"    // Nikon RAW
        + (experimental
           ...
           : "")    // Samsung RAW
               , ";");
    public static final RegexFileFilter DNG_FILENAMES = new RegexFileFilter(".*\\.[dD][nN][gG];"    // Digal Negative
        , ";");
    public static final RegexFileFilter JPEG_FILENAMES =
        new RegexFileFilter(".*\\.[jJ][pP][gG];"    // Joint Photographic Experts Group
        + ".*\\.[jJ][pP][eE][gG];"    // Joint Photographic Experts Group
            , ";");
    public static final RegexFileFilter TIFF_FILENAMES =
        new RegexFileFilter(".*\\.[tT][iI][fF];"    // Tagged Image File Format
        + ".*\\.[tT][iI][fF][fF];"    // Tagged Image File Format
            , ";");
