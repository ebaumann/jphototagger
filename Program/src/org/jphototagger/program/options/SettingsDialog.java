package org.jphototagger.program.options;
...
public final class SettingsDialog extends Dialog {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        panelTasks = new org.jphototagger.program.options.ScheduledTasksSettingsPanel();
        panelPerformance = new org.jphototagger.program.options.SettingsPerformancePanel();
        panelFileExcludePatterns = new org.jphototagger.program.module.fileexcludepatterns.SettingsFileExcludePatternsPanel();
        panelMisc = new org.jphototagger.program.options.MiscSettingsPanel();
        panelActions = new org.jphototagger.program.module.actions.SettingsActionsPanel();
        panelPlugins = new org.jphototagger.program.plugins.SettingsPluginsPanel();
        panelDisplayMessagesInFuture = new org.jphototagger.program.options.DisplayMessagesInFutureSettingsPanel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("org/jphototagger/program/options/Bundle"); // NOI18N
    ...
    private org.jphototagger.program.module.actions.SettingsActionsPanel panelActions;
    private org.jphototagger.program.options.DisplayMessagesInFutureSettingsPanel panelDisplayMessagesInFuture;
    private org.jphototagger.program.module.fileexcludepatterns.SettingsFileExcludePatternsPanel panelFileExcludePatterns;
    private org.jphototagger.program.options.MiscSettingsPanel panelMisc;
    private org.jphototagger.program.options.SettingsPerformancePanel panelPerformance;
    private org.jphototagger.program.plugins.SettingsPluginsPanel panelPlugins;
    ...
    private org.jphototagger.program.options.ScheduledTasksSettingsPanel panelTasks;
