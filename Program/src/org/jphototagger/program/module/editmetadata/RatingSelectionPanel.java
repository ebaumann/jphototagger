...
public class RatingSelectionPanel extends PanelExt implements TextEntry, FocusListener, KeyListener {
    ...
    private void buttonNoRatingMousePressed(java.awt.event.MouseEvent evt) {
        handleButtonPressed((JButton) evt.getSource());
    }

    private void buttonStar1MousePressed(java.awt.event.MouseEvent evt) {
        handleButtonPressed((JButton) evt.getSource());
    }

    private void buttonStar2MousePressed(java.awt.event.MouseEvent evt) {
        handleButtonPressed((JButton) evt.getSource());
    }

    private void buttonStar3MousePressed(java.awt.event.MouseEvent evt) {
        handleButtonPressed((JButton) evt.getSource());
    }

    private void buttonStar4MousePressed(java.awt.event.MouseEvent evt) {
        handleButtonPressed((JButton) evt.getSource());
    }

    private void buttonStar5MousePressed(java.awt.event.MouseEvent evt) {
        handleButtonPressed((JButton) evt.getSource());
    }
