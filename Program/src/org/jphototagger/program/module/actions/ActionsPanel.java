...
public final class ActionsPanel extends PanelExt {
    ...
    private void menuItemExecuteActionPerformed(java.awt.event.ActionEvent evt) {
        executeAction();
    }
    ...
    private void menuItemCreateActionPerformed(java.awt.event.ActionEvent evt) {
        createAction();
    }
    ...
    private void menuItemMoveActionUpActionPerformed(java.awt.event.ActionEvent evt) {
        moveActionUp();
}

    private void menuItemMoveActionDownActionPerformed(java.awt.event.ActionEvent evt) {
        moveActionDown();
}
