...
public final class ThumbnailsSortComboBoxModel extends DefaultComboBoxModel<Object> {
    ...
    private void addFileSorters() {
        ...
        addElement(new FileSorter(FileSort.PATHS_NATURAL_ORDER_ASCENDING.getComparator(),
                Bundle.getString(ThumbnailsSortComboBoxModel.class, "ThumbnailsSortComboBoxModel.DisplayName.ComparatorFilePathNaturalOrderAscending")));
        addElement(new FileSorter(FileSort.PATHS_NATURAL_ORDER_DESCENDING.getComparator(),
                Bundle.getString(ThumbnailsSortComboBoxModel.class, "ThumbnailsSortComboBoxModel.DisplayName.ComparatorFilePathNaturalOrderDescending")));
        ...
        addElement(new FileSorter(FileSort.SIZE_ASCENDING.getComparator(),
                Bundle.getString(ThumbnailsSortComboBoxModel.class, "ThumbnailsSortComboBoxModel.DisplayName.ComparatorFileSizeAscending")));
        addElement(new FileSorter(FileSort.SIZE_DESCENDING.getComparator(),
                Bundle.getString(ThumbnailsSortComboBoxModel.class, "ThumbnailsSortComboBoxModel.DisplayName.ComparatorFileSizeDescending")));
