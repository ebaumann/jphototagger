...
public final class ThumbnailsSettingsPanel extends PanelExt implements Persistence, HelpPageProvider {
    ...
    private void textFieldExternalThumbnailCreationCommandKeyReleased(java.awt.event.KeyEvent evt) {
        handleTextFieldExternalThumbnailCreationCommandKeyReleased();
    }

    private void radioButtonCreateThumbnailsWithExternalAppActionPerformed(java.awt.event.ActionEvent evt) {
        setThumbnailCreator((JRadioButton) evt.getSource());
    }

    private void radioButtonCreateThumbnailsWithJPhotoTaggerActionPerformed(java.awt.event.ActionEvent evt) {
        setThumbnailCreator((JRadioButton) evt.getSource());
    }

    private void buttonChooseExternalThumbnailCreatorActionPerformed(java.awt.event.ActionEvent evt) {
        chooseExternalThumbnailCreator();
    }

    private void checkBoxDisplayThumbnailTooltipActionPerformed(java.awt.event.ActionEvent evt) {
        setDisplayThumbnailTooltip();
    }

    private void checkBoxDisplayThumbnailsBottomPanelActionPerformed(java.awt.event.ActionEvent evt) {
        setDisplayThumbnailsBottomPanel();
    }

    private void buttonThumbnailCreatorsSettingsActionPerformed(java.awt.event.ActionEvent evt) {
