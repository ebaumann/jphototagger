...
public final class ThumbnailsPopupMenu extends JPopupMenu {
    ...
    private final JMenu menuRefresh = org.jphototagger.resources.UiFactory.menu(Bundle.getString(ThumbnailsPopupMenu.class, "ThumbnailsPopupMenu.DisplayName.MenuRefresh"));
    private final JMenu menuPrograms = org.jphototagger.resources.UiFactory.menu(Bundle.getString(ThumbnailsPopupMenu.class, "ThumbnailsPopupMenu.DisplayName.MenuOtherOpenImageApps"));
    private final JMenu menuMetadata = org.jphototagger.resources.UiFactory.menu(Bundle.getString(ThumbnailsPopupMenu.class, "ThumbnailsPopupMenu.DisplayName.MenuMetadata"));
    private final JMenu menuImageCollection = org.jphototagger.resources.UiFactory.menu(Bundle.getString(ThumbnailsPopupMenu.class, "ThumbnailsPopupMenu.DisplayName.MenuImageCollection"));
    private final JMenu menuRotateThumbnail = org.jphototagger.resources.UiFactory.menu(Bundle.getString(ThumbnailsPopupMenu.class, "ThumbnailsPopupMenu.DisplayName.MenuRotateThumbnail"));
    private final JMenu menuRating = org.jphototagger.resources.UiFactory.menu(Bundle.getString(ThumbnailsPopupMenu.class, "ThumbnailsPopupMenu.DisplayName.menuRating"));
    private final JMenu menuPlugins = org.jphototagger.resources.UiFactory.menu(Bundle.getString(ThumbnailsPopupMenu.class, "ThumbnailsPopupMenu.DisplayName.MenuPlugins"));
    private final JMenu menuSelection = org.jphototagger.resources.UiFactory.menu(Bundle.getString(ThumbnailsPopupMenu.class, "ThumbnailsPopupMenu.DisplayName.MenuSelection"));
    private final JMenu menuFsOps = org.jphototagger.resources.UiFactory.menu(Bundle.getString(ThumbnailsPopupMenu.class, "ThumbnailsPopupMenu.DisplayName.MenuFileSystemOps"));
