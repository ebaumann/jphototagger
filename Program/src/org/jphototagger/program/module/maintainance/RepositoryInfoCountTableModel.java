 ...
 */
public final class RepositoryInfoCountTableModel extends TableModelExt {
    ...
    public RepositoryInfoCountTableModel() {
    ...
    private void addColumnHeaders() {
        addColumn(Bundle.getString(RepositoryInfoCountTableModel.class, "RepositoryInfoTableModel.HeaderColumn.1"));
        addColumn(Bundle.getString(RepositoryInfoCountTableModel.class, "RepositoryInfoTableModel.HeaderColumn.2"));
    }
