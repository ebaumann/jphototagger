...
public class WordsetsPanel extends PanelExt {
    ...
    private void comboBoxWordsetNamesActionPerformed(java.awt.event.ActionEvent evt) {
        setWordsOfSelectedWordsetName();
        setButtonsEnabled();
    }

    private void buttonAddWordsetActionPerformed(java.awt.event.ActionEvent evt) {
        addWordset();
    }

    private void buttonRemoveWordsetActionPerformed(java.awt.event.ActionEvent evt) {
        removeSelectedWordset();
    }

    private void buttonEditWordsetActionPerformed(java.awt.event.ActionEvent evt) {
        editSelectedWordset();
    }

    private void buttonEraseAutomaticWordsActionPerformed(java.awt.event.ActionEvent evt) {
