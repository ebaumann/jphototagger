...
public final class ExifFormatterFactory {
    ...
    static {
        ...
        FORMATTER_OF_EXIF_IFD_TAG_ID.put(ExifTag.Id.FOCAL_LENGTH_IN_35_MM_FILM.value(), ExifFormatterFocalLengthIn35mm.INSTANCE);
    ...
    public static ExifFormatter get(ExifTag exifTag) {
        ...
        switch (ifdType) {
            case EXIF: return FORMATTER_OF_EXIF_IFD_TAG_ID    .get(tagId);
