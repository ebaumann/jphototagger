/*
 * @(#)DatabaseMetadataTemplatesEvent.java    Created on 2010-01-05
 *
...
public final class DatabaseMetadataTemplatesEvent {
    public enum Type { ADDED, DELETED, UPDATED,
    ; }
    ...
    public DatabaseMetadataTemplatesEvent(Type type, MetadataTemplate template,
            MetadataTemplate oldTemplate, Object source) {
        this.type        = type;
