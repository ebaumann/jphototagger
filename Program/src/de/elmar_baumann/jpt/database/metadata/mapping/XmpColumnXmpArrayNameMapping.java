...
public final class XmpColumnXmpArrayNameMapping {
    ...
    static {
        ...
        XMP_ARRAY_NAME_OF_COLUMN.put(ColumnXmpDcDescription.INSTANCE,
                                     "dc:description");
        XMP_ARRAY_NAME_OF_COLUMN.put(ColumnXmpDcRights.INSTANCE, "dc:rights");
        XMP_ARRAY_NAME_OF_COLUMN.put(ColumnXmpDcSubjectsSubject.INSTANCE,
                                     "dc:subject");
        XMP_ARRAY_NAME_OF_COLUMN.put(ColumnXmpDcTitle.INSTANCE, "dc:title");
        XMP_ARRAY_NAME_OF_COLUMN.put(ColumnXmpIptc4xmpcoreCountrycode.INSTANCE,
                                     "Iptc4xmpCore:CountryCode");
        XMP_ARRAY_NAME_OF_COLUMN.put(ColumnXmpIptc4XmpCoreDateCreated.INSTANCE,
                                     "Iptc4xmpCore:DateCreated");
        XMP_ARRAY_NAME_OF_COLUMN.put(ColumnXmpIptc4xmpcoreLocation.INSTANCE,
                                     "Iptc4xmpCore:Location");
        XMP_ARRAY_NAME_OF_COLUMN.put(
            ColumnXmpPhotoshopAuthorsposition.INSTANCE,
            "photoshop:AuthorsPosition");
        XMP_ARRAY_NAME_OF_COLUMN.put(ColumnXmpPhotoshopCaptionwriter.INSTANCE,
                                     "photoshop:CaptionWriter");
        XMP_ARRAY_NAME_OF_COLUMN.put(ColumnXmpPhotoshopCity.INSTANCE,
                                     "photoshop:City");
        XMP_ARRAY_NAME_OF_COLUMN.put(ColumnXmpPhotoshopCountry.INSTANCE,
                                     "photoshop:Country");
        XMP_ARRAY_NAME_OF_COLUMN.put(ColumnXmpPhotoshopCredit.INSTANCE,
                                     "photoshop:Credit");
        XMP_ARRAY_NAME_OF_COLUMN.put(ColumnXmpPhotoshopHeadline.INSTANCE,
                                     "photoshop:Headline");
        XMP_ARRAY_NAME_OF_COLUMN.put(ColumnXmpPhotoshopInstructions.INSTANCE,
                                     "photoshop:Instructions");
        XMP_ARRAY_NAME_OF_COLUMN.put(ColumnXmpPhotoshopSource.INSTANCE,
                                     "photoshop:Source");
        XMP_ARRAY_NAME_OF_COLUMN.put(ColumnXmpPhotoshopState.INSTANCE,
                                     "photoshop:State");
        XMP_ARRAY_NAME_OF_COLUMN.put(
