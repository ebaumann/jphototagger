    ...
    private void initComponents() {
        ...
        list.setTransferHandler(
            new TransferHandlerDragListItems(
                de.elmar_baumann.jpt.datatransfer.Flavor.KEYWORDS_LIST));
        ...
        tree.setTransferHandler(new de.elmar_baumann.jpt.datatransfer
            .TransferHandlerKeywordsTree());
        ...
        buttonAsList.setText(
            bundle.getString("KeywordsPanel.buttonAsList.text"));    // NOI18N
        ...
        buttonToggleExpandAllNodes.setText(
            bundle.getString("KeywordsPanel.buttonToggleExpandAllNodes.text"));    // NOI18N
        buttonToggleExpandAllNodes.setMargin(new java.awt.Insets(2, 2, 2, 2));
        buttonToggleExpandAllNodes.addActionListener(
        ...
        labelInfoListView.setText(
            bundle.getString("KeywordsPanel.labelInfoListView.text"));    // NOI18N
        gridBagConstraints         = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx   = 0;
        gridBagConstraints.gridy   = 1;
        gridBagConstraints.fill    = java.awt.GridBagConstraints.BOTH;
        ...
        buttonAsTree.setText(
            bundle.getString("KeywordsPanel.buttonAsTree.text"));    // NOI18N
