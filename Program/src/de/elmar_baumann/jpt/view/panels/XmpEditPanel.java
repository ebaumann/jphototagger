 ...
 * @version 2010-01-08
 */
public class XmpEditPanel extends javax.swing.JPanel implements FocusListener {
    ...
    public boolean isDirty() {
        for (TextEntry textEntry : textEntries) {
            if (textEntry.isDirty()) return true;
        }
        return false;
    }
    ...
    private void scrollToVisible(Component c) {
        ...
        TextEntry textEntry = c instanceof TextEntry ? (TextEntry) c : null;
    ...
    private void initComponents() {
        ...
        panelDcSubjects = new de.elmar_baumann.jpt.view.panels.EditRepeatableTextEntryPanel();
        panelDcTitle = new de.elmar_baumann.jpt.view.panels.EditTextEntryPanel();
        panelDcDescription = new de.elmar_baumann.jpt.view.panels.EditTextEntryPanel();
        panelPhotoshopHeadline = new de.elmar_baumann.jpt.view.panels.EditTextEntryPanel();
        panelIptc4xmpcoreLocation = new de.elmar_baumann.jpt.view.panels.EditTextEntryPanel();
        panelIptc4XmpCoreDateCreated = new de.elmar_baumann.jpt.view.panels.EditTextEntryPanel();
        panelPhotoshopAuthorsposition = new de.elmar_baumann.jpt.view.panels.EditTextEntryPanel();
        panelDcCreator = new de.elmar_baumann.jpt.view.panels.EditTextEntryPanel();
        panelPhotoshopCity = new de.elmar_baumann.jpt.view.panels.EditTextEntryPanel();
        panelPhotoshopState = new de.elmar_baumann.jpt.view.panels.EditTextEntryPanel();
        panelPhotoshopCountry = new de.elmar_baumann.jpt.view.panels.EditTextEntryPanel();
        panelDcRights = new de.elmar_baumann.jpt.view.panels.EditTextEntryPanel();
        panelPhotoshopCredit = new de.elmar_baumann.jpt.view.panels.EditTextEntryPanel();
        panelPhotoshopSource = new de.elmar_baumann.jpt.view.panels.EditTextEntryPanel();
