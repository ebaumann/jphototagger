...
public final class FileExcludePatternsExporter implements Exporter {
    ...
    public static final FileFilter                  FILE_FILTER = new FileNameExtensionFilter(JptBundle.INSTANCE.getString("FileExcludePatternsExporter.DisplayName.FileFilter"), "xml");
    ...
    public void exportFile(File file) {
        ...
        try {
            ...
            XmlObjectExporter.export(new CollectionWrapper(StringWrapper.getWrappedStrings(patterns)), file);
        } catch (Exception ex) {
