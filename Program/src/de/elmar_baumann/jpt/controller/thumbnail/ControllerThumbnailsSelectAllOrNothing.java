...
public final class ControllerThumbnailsSelectAllOrNothing implements ActionListener {
    ...
    private final JMenuItem       itemSelectAll    = PopupMenuThumbnails.INSTANCE.getItemSelectAll();
    private final JMenuItem       itemSelectNoting = PopupMenuThumbnails.INSTANCE.getItemSelectNothing();
