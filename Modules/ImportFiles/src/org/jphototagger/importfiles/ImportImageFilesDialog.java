...
public class ImportImageFilesDialog extends DialogExt {
    ...
    private void buttonChooseSourceDirActionPerformed(java.awt.event.ActionEvent evt) {
        setDir(buttonChooseSourceDir, chooseSourceDirAction, prevSelectedSourceDirs, setSourceDirFunctor);
    }

    private void buttonChooseTargetDirActionPerformed(java.awt.event.ActionEvent evt) {
        setDir(buttonChooseTargetDir, chooseTargetDirAction, prevSelectedTargetDirs, setTargetDirFunctor);
    }

    private void buttonChooseFilesActionPerformed(java.awt.event.ActionEvent evt) {
        chooseSourceFiles();
        toFront();
    }

    private void checkBoxDeleteAfterCopyActionPerformed(java.awt.event.ActionEvent evt) {
        handleCheckBoxDeleteAfterCopyPerformed();
    }

    private void buttonChooseScriptFileActionPerformed(java.awt.event.ActionEvent evt) {
        chooseAndSetScriptFile();
        toFront();
    }

    private void buttonRemoveScriptFileActionPerformed(java.awt.event.ActionEvent evt) {
        removeScriptFile();
    }

    private void comboBoxSubdirectoryCreateStrategyActionPerformed(java.awt.event.ActionEvent evt) {
        persistSubdirectoryCreateStrategy();
    }

    private void comboBoxFileRenameStrategyActionPerformed(java.awt.event.ActionEvent evt) {
        persistFileRenameStrategy();
    }

    private void comboBoxSourceStrategyActionPerformed(java.awt.event.ActionEvent evt) {
        setSourceStrategy();
    }

    private void buttonExpertSettingsActionPerformed(java.awt.event.ActionEvent evt) {
        showExpertSettings();
    }

    private void buttonEditRenameTemplatesActionPerformed(java.awt.event.ActionEvent evt) {
        editRenameTemplates();
    }
