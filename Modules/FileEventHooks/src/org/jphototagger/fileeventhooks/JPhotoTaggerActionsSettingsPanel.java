...
public class JPhotoTaggerActionsSettingsPanel extends javax.swing.JPanel {
    ...
    private static class FilenameSuffixesListModel extends DefaultListModel {
        ...
        private void addElements() {
            ...
            if (prefs != null) {
                Set<String> suffixes = new HashSet<String>(prefs.getStringCollection(PreferencesKeys.FILENAME_SUFFIXES_KEY));
        ...
        private void updatePreferences() {
            Preferences prefs = Lookup.getDefault().lookup(Preferences.class);
            prefs.setStringCollection(PreferencesKeys.FILENAME_SUFFIXES_KEY,
