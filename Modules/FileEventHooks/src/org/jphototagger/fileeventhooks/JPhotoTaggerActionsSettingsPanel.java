...
public class JPhotoTaggerActionsSettingsPanel extends PanelExt {
    ...
    private void buttonAddFilenameSuffixActionPerformed(java.awt.event.ActionEvent evt) {
        addFilenameSuffix();
        textFieldFilenameSuffix.requestFocusInWindow();
    }

    private void buttonRemoveSelectedFilenameSuffixActionPerformed(java.awt.event.ActionEvent evt) {
        removeSelectedFilenameSuffix();
        textFieldFilenameSuffix.requestFocusInWindow();
    }

    private void buttonRenameSelectedFilenameSuffixActionPerformed(java.awt.event.ActionEvent evt) {
        renameSelectedFilenameSuffix();
    }
    ...
    private void textFieldFilenameSuffixKeyTyped(java.awt.event.KeyEvent evt) {
