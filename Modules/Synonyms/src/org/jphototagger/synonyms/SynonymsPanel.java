...
public class SynonymsPanel extends PanelExt implements ListSelectionListener, DocumentListener {
    ...
    private void buttonAddWordActionPerformed(java.awt.event.ActionEvent evt) {
        addWord();
    }

    private void buttonRemoveWordActionPerformed(java.awt.event.ActionEvent evt) {
        removeWord();
    }

    private void buttonChangeWordActionPerformed(java.awt.event.ActionEvent evt) {
        changeWord();
    }

    private void buttonAddSynonymActionPerformed(java.awt.event.ActionEvent evt) {
        addSynonym();
    }

    private void buttonRemoveSynonymActionPerformed(java.awt.event.ActionEvent evt) {
        removeSynonym();
    }

    private void buttonChangeSynonymActionPerformed(java.awt.event.ActionEvent evt) {
        changeSynonym();
    }

    private void textAreaWordsKeyPressed(java.awt.event.KeyEvent evt) {
        handleTextAreaWordsKeyPressed(evt);
    }

    private void textFieldSynonymsKeyPressed(java.awt.event.KeyEvent evt) {
        handleTextFieldSynonymsKeyPressed(evt);
    }

    private void listSynonymsKeyPressed(java.awt.event.KeyEvent evt) {
        handleListSynonymsKeyPressed(evt);
    }

    private void listWordsMouseClicked(java.awt.event.MouseEvent evt) {
        handleListWordsMouseClicked(evt);
    }

    private void listSynonymsMouseClicked(java.awt.event.MouseEvent evt) {
        handleListSynonymsMouseClicked(evt);
    }

    private void listWordsKeyPressed(java.awt.event.KeyEvent evt) {
        handleListWordsKeyPressed(evt);
    }

    private void buttonAddAllKeywordsActionPerformed(java.awt.event.ActionEvent evt) {
        addAllKeywords();
    }

    private void menuItemChangeWordActionPerformed(java.awt.event.ActionEvent evt) {
        changeWord();
    }

    private void menuItemRemoveWordActionPerformed(java.awt.event.ActionEvent evt) {
        removeWord();
    }

    private void menuItemRemoveSynonymActionPerformed(java.awt.event.ActionEvent evt) {
        removeSynonym();
    }

    private void menuItemChangeSynonymActionPerformed(java.awt.event.ActionEvent evt) {
        changeSynonym();
    }
