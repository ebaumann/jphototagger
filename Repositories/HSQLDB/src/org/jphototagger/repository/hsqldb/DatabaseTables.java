...
final class DatabaseTables extends Database {
    ...
    private static final String BLOB_COLUMN = "VARBINARY(" + Integer.MAX_VALUE + ")";
    ...
    private void createMetadataTemplateTable(Connection con, Statement stmt) throws SQLException {
        if (!DatabaseMetadata.INSTANCE.existsTable(con, "metadata_edit_templates")) {
            stmt.execute("CREATE CACHED TABLE metadata_edit_templates"
                    + " (name VARCHAR_IGNORECASE(256)"
                    + ", dcSubjects " + BLOB_COLUMN
                    + ", dcTitle " + BLOB_COLUMN
                    + ", photoshopHeadline " + BLOB_COLUMN
                    + ", dcDescription " + BLOB_COLUMN
                    + ", photoshopCaptionwriter " + BLOB_COLUMN
                    + ", iptc4xmpcoreLocation " + BLOB_COLUMN
                    + ", dcRights " + BLOB_COLUMN
                    + ", dcCreator " + BLOB_COLUMN
                    + ", photoshopAuthorsposition " + BLOB_COLUMN
                    + ", photoshopCity " + BLOB_COLUMN
                    + ", photoshopState " + BLOB_COLUMN
                    + ", photoshopCountry " + BLOB_COLUMN
                    + ", photoshopTransmissionReference " + BLOB_COLUMN
                    + ", photoshopInstructions " + BLOB_COLUMN
                    + ", photoshopCredit " + BLOB_COLUMN
                    + ", photoshopSource " + BLOB_COLUMN
                    + ", rating " + BLOB_COLUMN
                    + ", iptc4xmpcore_datecreated " + BLOB_COLUMN
                    + ");");
    ...
    private void createProgramsTable(Connection con, Statement stmt) throws SQLException {
        if (!DatabaseMetadata.INSTANCE.existsTable(con, "programs")) {
            stmt.execute("CREATE CACHED TABLE programs"
                    ...
                    + ", parameters_before_filename " + BLOB_COLUMN
                    + ", parameters_after_filename " + BLOB_COLUMN
