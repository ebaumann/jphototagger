    ...
    private void createMetadataTemplateTable(Connection con, Statement stmt) throws SQLException {
        if (!DatabaseMetadata.INSTANCE.existsTable(con, "metadata_edit_templates")) {
            stmt.execute("CREATE CACHED TABLE metadata_edit_templates"
                    + " (name VARCHAR_IGNORECASE(256)"
                    + ", dcSubjects BINARY(8000)"
                    + ", dcTitle BINARY(8000)"
                    + ", photoshopHeadline BINARY(8000)"
                    + ", dcDescription BINARY(8000)"
                    + ", photoshopCaptionwriter BINARY(8000)"
                    + ", iptc4xmpcoreLocation BINARY(8000)"
                    + ", dcRights BINARY(8000)"
                    + ", dcCreator BINARY(8000)"
                    + ", photoshopAuthorsposition BINARY(8000)"
                    + ", photoshopCity BINARY(8000)"
                    + ", photoshopState BINARY(8000)"
                    + ", photoshopCountry BINARY(8000)"
                    + ", photoshopTransmissionReference BINARY(8000)"
                    + ", photoshopInstructions BINARY(8000)"
                    + ", photoshopCredit BINARY(8000)"
                    + ", photoshopSource BINARY(8000)"
                    + ", rating BINARY(8000)"
                    + ", iptc4xmpcore_datecreated BINARY(8000)"
                    + ");");
    ...
    private void createProgramsTable(Connection con, Statement stmt) throws SQLException {
        if (!DatabaseMetadata.INSTANCE.existsTable(con, "programs")) {
            stmt.execute("CREATE CACHED TABLE programs"
                    ...
                    + ", parameters_before_filename BINARY(8000)"
                    + ", parameters_after_filename BINARY(8000)"
