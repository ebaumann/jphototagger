...
public final class Xmp {
    ...
    public enum PropertyValueType {
        ...
        public boolean isArray() {
            return this.equals(BAG_TEXT) ||
                   this.equals(SEQ_PROPER_NAME) ||
                   this.equals(LANG_ALT);
        }

        public PropertyOptions getArrayPropertyOptions() {
            switch (this) {
                case BAG_TEXT       : return new PropertyOptions().setArray(true);
                case SEQ_PROPER_NAME: return new PropertyOptions().setArrayOrdered(true);
                case LANG_ALT       : return new PropertyOptions().setArrayAlternate(true);
                default             : return null;
            }
        }
    }
    ...
    public enum PropertyValue {
        ...
        PHOTOSHOP_TRANSMISSION_REFERENCE (Namespace.PHOTOSHOP  , "photoshop:TransmissionReference", PropertyValueType.TEXT),
        XAP_RATING                       (Namespace.XMP_BASIC  , "xap:Rating"                     , PropertyValueType.CLOSED_CHOICE)
        ;
    ...
    public static List<XMPPropertyInfo> getPropertyInfosOfSidecarFile(File sidecarFile) {
        if (sidecarFile == null) throw new NullPointerException("sidecarFile == null");
    ...
    public static List<String> getPropertyValuesFrom(Collection<? extends XMPPropertyInfo> xmpPropertyInfos, PropertyValue propertyValue) {
        ...
        if (propertyValue    == null) throw new NullPointerException("propertyValue == null");
        ...
        for (XMPPropertyInfo xmpPropertyInfo : xmpPropertyInfos) {
            ...
            if (xmpPropertyInfo.getNamespace() != null &&
               ...
               !xmpPropertyInfo.getOptions().isQualifier() &&
                ...
                xmpPropertyInfo.getPath().startsWith(propertyValue.getPath()) &&
