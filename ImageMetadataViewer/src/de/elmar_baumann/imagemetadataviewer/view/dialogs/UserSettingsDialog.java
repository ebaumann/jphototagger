...
import de.elmar_baumann.imagemetadataviewer.model.ComboBoxModelLogfileFormatter;
import de.elmar_baumann.imagemetadataviewer.model.ListModelAutoscanDirectories;
import de.elmar_baumann.lib.component.CheckList;
import de.elmar_baumann.imagemetadataviewer.model.ListModelFastSearchColumns;
import de.elmar_baumann.imagemetadataviewer.resource.Bundle;
import de.elmar_baumann.imagemetadataviewer.view.renderer.ListCellRendererLogfileFormatter;
    ...
    private void initComponents() {
        ...
        panelImageOpenAppsLayout.setVerticalGroup(
            ...
            .addGroup(panelImageOpenAppsLayout.createSequentialGroup()
                ...
                .addGroup(panelImageOpenAppsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelImageOpenAppsLayout.createSequentialGroup()
                        .addComponent(scrollPaneListOtherOpenImageApps, javax.swing.GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(panelImageOpenAppsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(buttonAddOtherOpenImageApp)
                            .addComponent(buttonRemoveOtherOpenImageApp)))
        ...
        panelSearchLayout.setVerticalGroup(
            ...
            .addGroup(panelSearchLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelSearchLayout.createSequentialGroup()
                    .addGap(38, 38, 38)
                    .addComponent(scrollPaneSearchColumns, javax.swing.GroupLayout.DEFAULT_SIZE, 261, Short.MAX_VALUE)
                    .addContainerGap()))
        );
        ...
        panelTasksAutoscanLayout.setVerticalGroup(
            ...
            .addGroup(panelTasksAutoscanLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(scrollPaneTasksAutoscanListDirectories, javax.swing.GroupLayout.DEFAULT_SIZE, 49, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(checkBoxTasksAutoscanIncludeSubdirectories)
        ...
        comboBoxThreadPriority.setModel(new de.elmar_baumann.imagemetadataviewer.model.ComboBoxModelThreadPriority());
