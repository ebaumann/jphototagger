...
import de.elmar_baumann.imagemetadataviewer.database.metadata.selections.ColumnIds;
import de.elmar_baumann.imagemetadataviewer.database.metadata.Comparator;
import de.elmar_baumann.imagemetadataviewer.database.metadata.Operator;
import de.elmar_baumann.imagemetadataviewer.database.metadata.selections.AdvancedSearchColumns;
...
public class SearchColumnPanel extends javax.swing.JPanel {
    ...
    private void setDate() {
        GregorianCalendar cal = DateChooserDialog.showDialog(this, AppSettings.getAppIcons());
        if (cal != null) {
    ...
    private void initComponents() {
        ...
        buttonCalendar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/elmar_baumann/imagemetadataviewer/resource/icon_calendar.png"))); // NOI18N
