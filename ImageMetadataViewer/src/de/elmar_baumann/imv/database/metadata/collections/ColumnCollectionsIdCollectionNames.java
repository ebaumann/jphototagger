 ...
 * @version 2008/09/07
 */
public class ColumnCollectionsIdCollectionNames extends Column {

    private static ColumnCollectionsIdCollectionNames instance = new ColumnCollectionsIdCollectionNames();
