...
public final class CommandLineParser {
    ...
    public static class Option {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.values != other.values && (this.values == null || !this.values.equals(other.values))) return false;
            return true;
        }
    ...
    public CommandLineParser(
        ...
        if (args                   == null) throw new NullPointerException("args == null"); // NOI18N
    ...
    public boolean hasOption(String name) {
        for (Option option : options) {
            if (option.name.equalsIgnoreCase(name)) return true;
        }
        return false;
    }
    ...
    public Option getOption(String name) {
        for (Option option : options) {
            if (option.name.equalsIgnoreCase(name)) return option;
        }
        return null;
    }
    ...
    private String ensureOptionName(String arg, int argIndex) {
        String optionName = arg.length() > 1 ? arg.substring(1) : null;
