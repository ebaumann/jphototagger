...
/**
 * En- and decrypts strings with <code>DESede</code> and BASE64 so that the
 * encrypted string can stored in a plain text file.
 *
 * Usage example:
 *
 * <pre>
 ...
 * {@code SecretKey key = KeyGenerator.getInstance("DESede").generateKey();}.
 *
...
final class Crypt {
     ...
     * @return     encrypted string BASE64 encoded or null on errors
     */
     ...
     * Decrypts a string.
     *
     * @param  str BASE64 encoded string to dencrypt
