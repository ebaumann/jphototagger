/*
 * @(#)DateChooserDialog.java    Created on 
 *
    ...
    private DateChooserDialog(GregorianCalendar calendar, Locale locale) {
        ...
        previousButton.setIcon(
            IconUtil.getImageIcon(
                "/de/elmar_baumann/lib/resource/icons/icon_datechooser_prev.png"));
        ...
        nextButton.setIcon(
            IconUtil.getImageIcon(
                "/de/elmar_baumann/lib/resource/icons/icon_datechooser_next.png"));
