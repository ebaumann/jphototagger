...
public final class HelpBrowser extends DialogExt implements HyperlinkListener, TreeSelectionListener, PropertyChangeListener {
    ...
    private void menuItemTextFontSizeSmallActionPerformed(java.awt.event.ActionEvent evt) {
        setTextFontSizeOfMenuItem(menuItemTextFontSizeSmall);
    }

    private void menuItemTextFontSizeNormalActionPerformed(java.awt.event.ActionEvent evt) {
        setTextFontSizeOfMenuItem(menuItemTextFontSizeNormal);
    }

    private void menuItemTextFontSizeLargeActionPerformed(java.awt.event.ActionEvent evt) {
        setTextFontSizeOfMenuItem(menuItemTextFontSizeLarge);
    }

    private void menuItemTextFontSizeHugeActionPerformed(java.awt.event.ActionEvent evt) {
