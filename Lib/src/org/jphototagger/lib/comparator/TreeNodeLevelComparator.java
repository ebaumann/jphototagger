 ...
 */
public final class TreeNodeLevelComparator implements Comparator<DefaultMutableTreeNode>, Serializable {

    /**
     * Sorts tree nodes in ascending order: A node with a lower level is before
     * a node with a higher level.
     */
    public static final TreeNodeLevelComparator ASCENDING = new TreeNodeLevelComparator(CompareOrder.ASCENDING);
    /**
     * Sorts tree nodes in descending order: A node with a higher level is
     * before a node with a lower level.
     */
    public static final TreeNodeLevelComparator DESCENDING = new TreeNodeLevelComparator(CompareOrder.DESCENDING);
    ...
    private TreeNodeLevelComparator(CompareOrder order) {
        this.order = order;
    }
