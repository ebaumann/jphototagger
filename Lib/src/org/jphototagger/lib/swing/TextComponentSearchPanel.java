...
public class TextComponentSearchPanel extends PanelExt implements DocumentListener {
    ...
    private void buttonSearchDownwardsActionPerformed(java.awt.event.ActionEvent evt) {
        searchDown();
    }

    private void buttonSearchUpwardsActionPerformed(java.awt.event.ActionEvent evt) {
        searchUp();
    }
